...
export default function gcv4WheelerPackagePolicy() {
  const policy = "GCV4WheelerPackagePolicy"
    ...
    >
      ...
      <View>
        ...
        <View style={styles.row}>
          ...
          <TextInput style={styles.textInput} placeholder="Enter the GVW" value={gvwValue} onChange={event => setGVWValue(event.nativeEvent.text)} inputMode="numeric"/>
        </View>
