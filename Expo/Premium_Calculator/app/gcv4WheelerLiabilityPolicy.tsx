...
export default function gcv3WheelerLiabilityPolicy() {
  const policy = "GCV4WheelerLiabilityPolicy"
  ...
  const gvwData = [{label: '< 7500 Kg', value:'< 7500 Kg'}, {label: '7500-12000 Kg', value:'7500-12000 Kg'}, {label: '12000-20000 Kg', value:'12000-20000 Kg'}, {label: '20000-40000 Kg', value:'20000-40000 Kg'}, {label: 'Exceeding 40000 Kg', value:'Exceeding 40000 Kg'}]
    ...
    >
      ...
      <View>
        ...
        <View style={styles.row}>
          <Text style={styles.text}>GVW (Kg)</Text>
          <Dropdown 
            labelField="label" 
            valueField="value" 
            ...
            placeholder="Select"
            value={gvwValue} 
            onChange={item => {setGVWValue(item.value);}}/>
        </View>
